...
import "./ConnectLargerWorld.css";

const ConnectLargerWorld = () => {
  ...
  return (
    <AppContainer>
      <AppSection>
        <div className="connect-larger-world-container d-flex">
          <div className="left-side">
            <Heading1>connect larger.world</Heading1>
            <p className="connect-under-header">
            ...
            <form
              onSubmit={(e: React.FormEvent<HTMLFormElement>) => {
                ...
                if (
                  textareaRegex.test(commentInput) &&
            ...
            >
              ...
              <div className="agree-holder">
                <input type="checkbox" />
                <p>
                  i agree that larger.world may contact me at the email address
          ...
          <div className="right-side">
            <img
              src="../../../../public/images/landing-page/connect-larger-world/connect-leaf.svg"
              alt=""
            />
          </div>
        </div>
...
export default ConnectLargerWorld;
